...
module.exports = Router = (function() {
  ...
  */
  ...
  Router.prototype.dispatch = function(url) {
    var creator, handler, options, parser, _i, _len, _ref, _ref1;
    url = this.normalizeUrl(url);
    _ref = this.rules;
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      _ref1 = _ref[_i], parser = _ref1[0], creator = _ref1[1], handler = _ref1[2];
  ...
  */
  ...
  Router.prototype.createUrl = function(options) {
    var creator, handler, parser, url, _i, _len, _ref, _ref1;
    _ref = this.rules;
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      _ref1 = _ref[_i], parser = _ref1[0], creator = _ref1[1], handler = _ref1[2];
...
rtr.add("<controller:(\\w+)>/<id:\\d+>/_<action>", function(options) {
  return console.log("HELLO", options);
});

rtr.add("<controller:(\\w+)>/_<action>", function(options) {
  return console.log("HELLO 2 ", options);
});

rtr.add("<controller:(\\w+)>", function(options) {
  return console.log("HELLO 3", options);
});
